...
@Component({
  ...
  templateUrl: './sv-restaurant-landing-page.component.html',
  styleUrls: ['./sv-restaurant-landing-page.component.scss'],
})
export class SvRestaurantLandingPageComponent implements OnInit, AfterViewInit {
  ...
  getOfferKey(): string {
    let offerKey = 'SV_RESTAURANT_OFFER_DETAILS';
    return offerKey;
  }

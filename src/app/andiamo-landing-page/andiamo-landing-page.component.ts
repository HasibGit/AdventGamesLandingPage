...
@Component({
  ...
  templateUrl: './andiamo-landing-page.component.html',
  styleUrls: ['./andiamo-landing-page.component.scss'],
})
export class AndiamoLandingPageComponent implements OnInit, AfterViewInit {
  ...
  getOfferKey(): string {
    let offerKey = 'ANDIAMO_OFFER_DETAILS';
    return offerKey;
  }
  ...
  openGameInNewTab() {
    window.open(andiamoConfig.gameUrl, '_blank');
  }
}
